package com.example.network.server.node_handler.user_map;

import com.example.network.server.util.custom_exceptions.NetworkIsFull;
import com.example.network.server.util.custom_exceptions.YouAreAlone;
import com.example.network.util.Address;
import com.example.network.util.Pair;
...
public class UserMap {
    ...
    public void newPeeringServer(String publicKey, Address address) throws Exception {
        if (isServer(publicKey)) throw new Exception();
